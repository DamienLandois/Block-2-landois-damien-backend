...
describe('AuthController', () => {
  ...
  describe('login', () => {
    ...
    it('should return access token and user data on successful login', async () => {
      ...
      const mockAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1MSIsImVtYWlsIjoiZGFtaWVuLmxhbmRvaXNAdGVzdC5jb20ifQ.token';
    ...
    it('should work with minimal user data', async () => {
      ...
      const mockAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1MiIsImVtYWlsIjoibWFyaWUuZHVwb250QHRlc3QuY29tIn0.token';
    ...
    it('should handle different user ID formats', async () => {
      ...
      const mockAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhYmMtMTIzLWRlZi00NTYiLCJlbWFpbCI6ImFudG9pbmUuZmFpbGxhQHRlc3QuY29tIn0.token';
    ...
    it('should propagate service errors', async () => {
      ...
      authService.signAccessToken.mockRejectedValue(new Error('JWT signing failed'));

      await expect(controller.login(mockRequest)).rejects.toThrow('JWT signing failed');
      expect(authService.signAccessToken).toHaveBeenCalledWith({
        id: 'u1',
        email: 'damien.landois@test.com',
      });
    ...
    it('should extract only id and email for token generation', async () => {
      ...
      const mockAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1MSIsImVtYWlsIjoic29waGllLm1hcnRpbkB0ZXN0LmNvbSJ9.clean';
