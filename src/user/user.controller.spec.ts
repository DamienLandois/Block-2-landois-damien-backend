...
describe('UserController', () => {
  ...
  describe('getUsers', () => {
    ...
    it('should return an array of users', async () => {
      const mockUsers = [
        { id: 'a1b2c3', email: 'damien.landois@test.com', firstname: 'Damien', name: 'Landois' },
        { id: 'u2', email: 'marie.george@test.com', firstname: 'Marie', name: 'George' },
      ];
  ...
  describe('getUser', () => {
    ...
    it('should return a single user by id', async () => {
      const mockUser = { id: 'a1b2c3', email: 'damien.landois@test.com', firstname: 'Damien', name: 'Landois' };
      const userId = 'a1b2c3';
